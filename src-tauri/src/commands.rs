...
pub fn handler() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
	tauri::generate_handler![
		...
		attachments::copy::clipboard_copy_notes,
		attachments::copy::clipboard_copy_attachments,
		attachments::drag::attachment_prepare_drag,
		attachments::drag::attachment_start_drag,
		attachments::drag::attachment_discard_drag,
